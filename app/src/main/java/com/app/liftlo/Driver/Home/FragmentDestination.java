...
public class FragmentDestination extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_maps_destination, container, false);
...
//        marker = mMap.addMarker(new MarkerOptions().position(latLng).title(""));
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom
                (new LatLng(dblLat, dblLon), 15.0f));
    ...
    public void init() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (location.equals("")) {
                    Toast.makeText(getActivity(), "Enter Destination Location", Toast.LENGTH_SHORT).show();
                    getLocationAndMoveCamera();
                } else {
//
                    ...
                    bundle.putString("Startlon", StartingLan + "");
    ...
    public void GeoCodefromLatLan(){
        ...
        try {
            addresses = gcd.getFromLocation(Double.parseDouble(StartingLat),
